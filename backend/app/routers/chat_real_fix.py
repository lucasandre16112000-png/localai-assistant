"""
LocalAI Assistant - Chat API (REAL FIX)
...
async def chat_completion_stream(
    ...
    try:
        ...
        async def generate():
            ...
            # ✅ SAVE RESPONSE (even if partial due to STOP)
            if full_response:
            ...
            fresh_conv = await conversation_service.get_conversation(db, conv_uuid)
            if fresh_conv and fresh_conv.message_count == 2:  # User + Assistant = 2
